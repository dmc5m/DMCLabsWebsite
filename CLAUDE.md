...
## Legal Pages
Terms and Privacy pages are fetched at build time from the shared [DMC-Labs-LLC/legal](https://github.com/DMC-Labs-LLC/legal) repo (`terms.md` and `privacy.md`). Rendered via `react-markdown` + `gray-matter` in `lib/legal.ts`.
